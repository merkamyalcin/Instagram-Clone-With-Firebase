...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let config = ParseClientConfiguration { (ParseMutableClientConfiguration) in
            //Sunucuyla parse'ı bağlama configürasyonları yapılmakta.
            ParseMutableClientConfiguration.applicationId = "944e6e9b5e6bf2dd6951ad8ceabccd0763e28c3c"
            ParseMutableClientConfiguration.clientKey = "b6125f3a5886db3fb7cb676df9412312b879585c"
            ParseMutableClientConfiguration.server = "http://ec2-18-221-7-93.us-east-2.compute.amazonaws.com:80/parse"
